...
- The dashboard stores its API key in browser localStorage so it persists across browser and container restarts. Use HTTPS and a trusted browser profile when accessing it through a reverse proxy.
